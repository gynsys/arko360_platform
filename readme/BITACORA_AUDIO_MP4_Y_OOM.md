...
- **Renderizado Correcto de Color en Formas:** En [SlideCanvas.jsx](file:///c:/Users/pablo/Documents/arko360_platform/admin/src/modules/biblioarko/pages/social-generator/components/SlideCanvas.jsx#L588), se adaptó el bloque de formas para que evalúe `IconComp` en todas las figuras (`circle`, `square`, `roundedSquare`, `blob1`, `star`, etc.) aplicando `color: el.color` y `fill: el.color` tanto en fill simple como en gradientes.
