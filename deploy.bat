...
python ssh_runner.py "cd /var/www/arko360_platform && git pull origin main && docker compose pull && docker compose up -d --build && docker compose exec backend python init_db.py"
